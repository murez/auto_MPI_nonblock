...
48:                                               ; preds = %33
  ...
  %58 = call i32 @MPI_Reduce(ptr noundef %10, ptr noundef %12, i32 noundef 1, i32 noundef 1275069450, i32 noundef 1476395011, i32 noundef 0, i32 noundef 1140850688)
...
61:                                               ; preds = %48
  ...
  %71 = call i32 (ptr, ...) @printf(ptr noundef @.str.4, double noundef %63, double noundef %70)
  br label %72

72:                                               ; preds = %61, %48
  %73 = load ptr, ptr %9, align 8
  call void @free(ptr noundef %73) #9
  %74 = call i32 @MPI_Barrier(i32 noundef 1140850688)
  %75 = call i32 @MPI_Finalize()
